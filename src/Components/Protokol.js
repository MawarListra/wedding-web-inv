...
function Protokol() {
    return (
        <div className='flex flex-col md:w-full md:h-full justify-center items-center mt-28 py-8 px-24 bg-protokol-image bg-cover' id='protokol'>
            <div className='flex flex-col justify-center items-center bg-transparent'>
                <text className='py-8 font-script text-4xl font-bold text-white'>Protokol Kesehatan</text>
                <div className='md:flex flex-col md:w-full md:h-full py-2 space-y-2 justify-center items-center'>
                    <div className='md:flex md:flex-row md:space-x-8 py-4'>
                        <div className='md:flex flex-col md:w-96 md:h-44 shadow-2xl rounded-xl justify-center items-center text-center space-y-2 bg-white'>
